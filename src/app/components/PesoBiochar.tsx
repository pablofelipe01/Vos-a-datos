  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <button
        onClick={handleClick}
        disabled={isSending}
        className="text-white text-lg font-semibold h-32 w-32 bg-blue-900 rounded-full shadow-lg transform transition-all hover:shadow-2xl hover:scale-105 active:scale-95 active:shadow-md disabled:opacity-50 flex items-center justify-center"
      >
        LONA 25K
      </button>
    </div>
